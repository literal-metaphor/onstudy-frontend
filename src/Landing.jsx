    ...
    <main className="roboto">
        ...
        <div className="row pe-lg-5">
          <div className="col-lg-6 d-flex flex-column justify-content-center align-items-center order-2 order-lg-2">
            ...
            <div className="align-self-lg-start">
              <a href="#" className="btn btn-lg fs-6 me-4 tw-text-white btn-success">Coba sekarang!</a>
              <a href="#fitur" className="btn btn-lg fs-6 btn-outline-success">Lihat lebih lanjut</a>
            </div>
          </div>
          <div className="col-lg-6 d-flex flex-column justify-content-center align-items-center order-1 order-lg-2 mb-4 mb-lg-0">
            <img src="Landing/Hero.svg" alt="Hero Image" className="tw-w-[320px] tw-h-[320px] align-self-lg-end" />
          </div>
        </div>
      </section>
      ...
      <section id="testimonial" className="container">
        ...
        <div className="row d-flex justify-content-center align-items-start">
          <div className="col-12 col-lg-4 mb-4 mb-lg-0 d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="col-12 col-lg-4 mb-4 mb-lg-0 d-flex flex-column justify-content-center align-items-center">
            ...
            <p className="tw-text-justify px-4 fst-italic">“I first heard about <span className="fw-bold tw-text-[#28A745]">onStudy</span> when I was searching for Google Classroom alternatives. <span className="fw-bold tw-text-[#28A745]">onStudy</span> is very similar in that regard, but it added more features within. Some of which are <span className="fw-bold">timed quizzes</span>, <span className="fw-bold">chatroom</span> where students can perform peer-to-peer <span className="fw-bold">collaboration</span>. Overall, a fine if not a <span className="fw-bold">good alternative</span> to Google Classroom.”</p>
            <div className="d-flex justify-content-center align-items-center pt-4">
              <img src="Landing/StarFill.svg" alt="Star Fill" className="me-2 tw-w-[24px] tw-h-[24px]"/>
              <img src="Landing/StarFill.svg" alt="Star Fill" className="me-2 tw-w-[24px] tw-h-[24px]"/>
              <img src="Landing/StarFill.svg" alt="Star Fill" className="me-2 tw-w-[24px] tw-h-[24px]"/>
      ...
      <section id="faq" className="container">
        <div className="row">
          <div className="col-12 col-lg-6 d-flex justify-content-center align-items-center">
            <img src="Landing/FAQ.svg" alt="FAQ Image" className="d-lg-block d-none tw-w-[360px] tw-h-[360px]"/>
            <img src="Landing/FAQ.svg" alt="FAQ Image" className="d-lg-none mb-4 tw-w-[240px] tw-h-[240px]"/>
          </div>
